		...
		<div class="col-md-12">
			<div class="panel panel-default panel-border-color panel-border-color-primary">
				...
				<div class="tab-container ">
									...
									<div class="col-md-6">
										<div class="row">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" onkeyup="sync()" id="phoneNo" ng-model="sender.phone_no" name="phoneNo" class="form-control err"  maxlength="10" placeholder="Enter Mobile" required isphoneno>
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="phone_no" maxlength="10" id="phoneNoo"  pattern="[0-9]{10}"  pattern="\d*" title="10 Digit mobile number." placeholder="Search Remitter" style="display:  inline-block; width: 180px; float:  left;"  maxlength="10" required>
