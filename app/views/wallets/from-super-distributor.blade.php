                  ...
                  <form class="form-signin" name="balanceRequestFrm" ng-submit="submit(balanceRequest)" novalidate>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                          <label class="control-label"><small>Super Distributor</small></label>
  ...
  angular.module('DIPApp')
    .controller('WalletRequestCtrl', ['$scope', '$http', function ($scope, $http) {
      ...
      function submit (balanceRequest) {
        ...
        $http.post('/api/v1/wallets/balance-requests/from-super-distributors', req)
        .then(data => {
          sweetAlert('Success', 'The Request for Wallet Balance has successfully been sent.', 'success')
          reset();
        }, function (err) {
